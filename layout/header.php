...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="Dashboard.php" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">StockWise System</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link $Sales_Report_Monthly" href="Sales_Report_Monthly.php">
          <i class="bi bi-file-earmark-text"></i>
      ...
      <li class="nav-item">
        <a class="nav-link $Stocks_Report_Monthly" href="Stocks_Report_Monthly.php">
          <i class="bi bi-file-earmark-text"></i>
          <span>Stocks Report Monthly</span>
        </a>
      </li>
      <!-- End F.A.Q Page Nav -->
